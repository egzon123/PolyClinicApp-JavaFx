...
public class KlinikaJpaController implements Serializable {
    ...
    public void create(Klinika klinika) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findKlinika(klinika.getKId()) != null) {
                throw new PreexistingEntityException("Klinika " + klinika + " already exists.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
