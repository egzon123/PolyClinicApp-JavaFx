...
public class StaffJpaController implements Serializable {
    ...
    public void create(Staff staff) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findStaff(staff.getSId()) != null) {
...
//                    if(pacientiListOld !=null){
//                          for (Pacienti pacientiListOldPacienti : pacientiListOld) {
//                              if(pacientiListOldPacienti !=null || pacientiListNew !=null){
...
//                if(pagesatListOldPagesat !=null || pagesatListNew !=null){
