...
public class PacientiJpaController implements Serializable {
    ...
    public void create(Pacienti pacienti) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findPacienti(pacienti.getPId()) != null) {
                throw new PreexistingEntityException("Pacienti " + pacienti + " already exists.", ex);
            }
            throw ex;
        } finally {
            if (em != null) {
